...
merge 1:1 accountnumber questionnumber columnnumber rownumber using "`climcit'/cdp_2021_step3.dta", update replace nogen

**SAVE as new dataset
save "`climcit'/cdp_2021 step4.dta" 
...
**SAVE as new dataset
save "`climcit'/cdp_2021 step5.dta" 
clear
